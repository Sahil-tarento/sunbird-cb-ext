...
import org.sunbird.calendar.service.CalendarBulkUploadConsumer;
...
public class OrgDesignationCompetencyBulkUploadConsumer {
    ...
    private Logger logger = LoggerFactory.getLogger(OrgDesignationCompetencyBulkUploadConsumer.class);
    @Autowired
